...
//        checks if the correct freeform answer was input by the player/ compares the correct answer
//r against the player's answer ignoring case, if the value match the returned integer is 0'
